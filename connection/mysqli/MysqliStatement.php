...
class MysqliStatement extends MysqliWrapper implements StatementInterface {
    const PARAM_TYPES = [
        PDO::PARAM_STR => 's',
        PDO::PARAM_BOOL => 'i',
        PDO::PARAM_NULL => 's',
    ...
    private function noResultException () {
        if (!($this->_result instanceof mysqli_result)) {
            throw new ConnectionException('result not found. maybe the statement was not executed?');
        }
